...
describe(`/administrator/organizations/invitations`, () => {
  ...
  describe('Invitations#GET', () => {
    it('should have row for invitation', async () => {
      ...
      const req = TestHelper.createRequest(`/administrator/organizations/invitations?accountid=${owner.account.accountid}`, 'GET')
      req.account = administrator.account
      req.session = administrator.session
    ...
    it('should enforce specified offset', async () => {
      ...
      const req = TestHelper.createRequest(`/administrator/organizations/invitations?accountid=${owner.account.accountid}&offset=10`, 'GET')
      req.account = administrator.account
      req.session = administrator.session
      const res = TestHelper.createResponse()
      res.end = async (str) => {
